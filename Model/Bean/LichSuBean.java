...
public class LichSuBean {
	...
	public LichSuBean(int maChiTietHD, String masach, String tensach, String tacgia, Long gia, String anh,
			String maloai, String sotap, Date ngaynhap, int soluong, Date date, int damua) {
		super();
