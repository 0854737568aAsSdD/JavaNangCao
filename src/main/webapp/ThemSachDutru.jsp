	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form"
				...
				<span class="contact100-form-title"> Thêm Sách
					<div>
				...
				<div class="wrap-input100 validate-input"
					data-validate="Name is required">
					<span class="label-input100">Tên Sách</span> <input id="txttensach"
				...
				<div class="wrap-input100 validate-input"
					...
					<span class="label-input100">Số Lượng</span> <input id="txtsoluong"
						...
						required="" type="number"> <span class="focus-input100"></span>
				</div>
